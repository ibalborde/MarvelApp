...
class CharacterDetailViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let fetchURL = (character.comics?.collectionURI)!
        self.fetchComicData(endpoint: fetchURL)
    ...
    private func fetchComicData(endpoint: String) {
        ProgressHUD.show()
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
       ...
       override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
           ...
           let cellId = getCellID(index: indexPath.row)
